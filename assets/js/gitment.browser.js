  ...
  if (error) {
    ...
    if (error === _constants.NOT_INITIALIZED_ERROR && user.login && user.login.toLowerCase() === instance.owner.toLowerCase()) {
      ...
      if (error === _constants.NOT_INITIALIZED_ERROR) {
          ...
          var editor = $('div.gitment-container.gitment-editor-container')[0];
          var header = $('div.gitment-container.gitment-header-container')[0];
...
function renderEditor(_ref3, instance) {
  ...
  // update by aimingoo
  var gitmentCopyright = '\n    <a class="gitment-editor-footer-tip" href="https://github.com/imsun/gitment" target="_blank">and powered by Gitment</a>';
  ...
  _createClass(Gitment, [{
    ...
    value: function post(body) {
      ...
      return this.getIssue().then(function (issue) {
        var matched = issue.comments_url.match(/^((https?:\/\/+){0,1}[^\/]*)(.*)/);
